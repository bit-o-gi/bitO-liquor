...
public class TradersCrawlService {

    private static final String NORMALIZED_SOURCE = "TRADERS";
    ...
    private final TradersScraper tradersScraper;

    @Transactional
    public List<LiquorPrice> scrapeLiquors() {
        log.info("Traders 크롤링 시작");

        List<Liquor> scraped = tradersScraper.scrapeLiquors();
        ...
        log.info("Traders 크롤링 완료 - 신규: {}, 업데이트: {}, 스킵(Info없음): {}", newCount, updateCount, skipCount);
